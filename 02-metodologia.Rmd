...
Para refinar o conceito, propomos a medição da viscosidade através da medição do tempo decorrido entre atos processuais em dois contextos: i) o tempo associado à movimentações serventuárias e ii) o tempo associado à decisões judiciais e outras intervenções dos magistrados. Justificamos essa separação admitindo que o tempo gasto pelos magistrados em uma determinada classe de processos fornece uma informação com relação à complexidade jurídica e factual do procesos que é diferente da informação fornecida pelo tempo gasto pelo serventuário.
