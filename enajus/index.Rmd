...
Para mensurar intervalos de tempo dos processos levantados, foi necessário adotar uma metodologia para classificação das movimentações dos processos. Isso foi feito a partir da reclassificação de todos os títulos das movimentações, separando-se os intervalos de tempo que gerariam demanda dos magistrados e s
