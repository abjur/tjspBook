...
```{r visc1, fig.cap='. **Razão de viscosidades (tempo total) versus dificuldade do caso', fig.width=4, fig.height=1.7, fig.align='center'}
readRDS("p_viscosidade1.rds") +
  scale_x_continuous(breaks = 1:10) +
  theme_minimal(11) +
  ggtitle(NULL) +
  labs(y = "Razão entre as\nviscosidades")
```

<br/>

```{r visc2, fig.cap='. **Razão de viscosidades (tempo da decisão) versus dificuldade do caso.', fig.width=4, fig.height=1.7, fig.align='center'}
